...
env = Environment(
    loader=FileSystemLoader('email_templates'), # before running create a folder named email_templates.
...
#download your progress report in csv format name it whatever you like.
